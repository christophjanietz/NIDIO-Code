	...
	* ABR
		if `"`module'"'=="abr" {
			...
			* Legal role
			...
			capture lab var scontractsoort "Temporary employment"
			...
			capture lab var job_end_caly "Ending date job within calendar year"
			capture lab var job_tenure "Overall starting date of job"
			capture lab var sbaandagen_month "Job days"
			capture lab var sbasisloon_month "Base pay"
			capture lab var sbasisuren_month "Base working hours"
			capture lab var sbijzonderebeloning_month "Total extra compensation"
			capture lab var sextrsal_month "End-of-year bonus"
			capture lab var sincidentsal_month "Bonus pay"
			capture lab var slningld_month "Total pay"
			capture lab var slnowrk_month "Overtime compensation"
			capture lab var soverwerkuren_month "Overtime hours"
			capture lab var sreguliereuren_month "Regular working hours"
			capture lab var svakbsl_month "Holiday allowance"
			capture lab var svoltijddagen_month "Full-time days"
			capture lab var ft_factor "Full-time factor"
			capture lab var mainjob "Main job (most total pay)"
	
			capture lab var sbaandagen_year "Job days"
			capture lab var sbasisloon_year "Base pay"
			capture lab var sbasisuren_year "Base working hours"
			capture lab var sbijzonderebeloning_year "Total extra compensation"
			capture lab var sextrsal_year "End-of-year bonus"
			capture lab var sincidentsal_year "Bonus pay"
			capture lab var slningld_year "Total pay"
			capture lab var slnowrk_year "Overtime compensation"
			capture lab var soverwerkuren_year "Overtime hours"
			capture lab var sreguliereuren_year "Regular working hours"
			capture lab var svakbsl_year "Holiday allowance"
			capture lab var svoltijddagen_year "Full-time days"
